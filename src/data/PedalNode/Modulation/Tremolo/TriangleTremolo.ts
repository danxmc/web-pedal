export interface TriangleTremoloOptions extends AudioNodeOptions {
  speed: number;
  volume: number;
}

export class TriangleTremolo extends GainNode {
  // Parameters
  volume: AudioParam;
  speed: AudioParam;
  ...
  constructor(audioContext: BaseAudioContext, options: TriangleTremoloOptions) {
