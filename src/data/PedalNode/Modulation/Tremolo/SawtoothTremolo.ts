export interface SawtoothTremoloOptions extends AudioNodeOptions {
  speed: number;
  volume: number;
}

export class SawtoothTremolo extends GainNode {
  // Parameters
  volume: AudioParam;
  speed: AudioParam;
  ...
  constructor(audioContext: BaseAudioContext, options: SawtoothTremoloOptions) {
