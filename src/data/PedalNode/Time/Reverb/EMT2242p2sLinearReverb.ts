...
export interface EMT2242p2sLinearReverbOptions extends AudioNodeOptions {
  wet: number;
  level: number;
}

export class EMT2242p2sLinearReverbNode extends GainNode {
  // Parameters
  wet: AudioParam;
  level: AudioParam;
  ...
  constructor(
    ...
    options: EMT2242p2sLinearReverbOptions
  ) {
    super(audioContext, {
      gain: 1,
    });
    ...
    getReverbBuffer(
      IMPULSE_RESPONSE.REVERB_FILES.emt2242p2sLinear,
      audioContext
