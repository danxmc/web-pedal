...
export interface TelephoneT65ReverbOptions extends AudioNodeOptions {
  wet: number;
  level: number;
}

export class TelephoneT65ReverbNode extends GainNode {
  // Parameters
  wet: AudioParam;
  level: AudioParam;
  ...
  constructor(audioContext: BaseAudioContext, options: TelephoneT65ReverbOptions) {
    super(audioContext, {
      gain: 1,
    });
    ...
    getReverbBuffer(IMPULSE_RESPONSE.REVERB_FILES.telephoneT65, audioContext).then(
