...
export interface ChurchHallReverbOptions extends AudioNodeOptions {
  wet: number;
  level: number;
}

export class ChurchHallReverbNode extends GainNode {
  // Parameters
  wet: AudioParam;
  level: AudioParam;
  ...
  constructor(
    ...
    options: ChurchHallReverbOptions
  ) {
    super(audioContext, {
      gain: 1,
    });
    ...
    getReverbBuffer(
      IMPULSE_RESPONSE.REVERB_FILES.churchHall,
      audioContext
