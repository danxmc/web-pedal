...
export interface EMT2241p0sHighReverbOptions extends AudioNodeOptions {
  wet: number;
  level: number;
}

export class EMT2241p0sHighReverbNode extends GainNode {
  // Parameters
  wet: AudioParam;
  level: AudioParam;
  ...
  constructor(audioContext: BaseAudioContext, options: EMT2241p0sHighReverbOptions) {
    super(audioContext, {
      gain: 1,
    });
    ...
    getReverbBuffer(IMPULSE_RESPONSE.REVERB_FILES.emt2241p0sHigh, audioContext).then(
