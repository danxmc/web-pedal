...
export interface FactoryHallReverbOptions extends AudioNodeOptions {
  wet: number;
  level: number;
}

export class FactoryHallReverbNode extends GainNode {
  // Parameters
  wet: AudioParam;
  level: AudioParam;
  ...
  constructor(
    ...
    options: FactoryHallReverbOptions
  ) {
    super(audioContext, {
      gain: 1,
    });
    ...
    getReverbBuffer(
      IMPULSE_RESPONSE.REVERB_FILES.factoryHall,
      audioContext
